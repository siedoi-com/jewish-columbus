<?php
/**
 * neutech-columbus functions and definitions
 *
 ...
 */
function neutech_columbus_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on neutech-columbus, use a find and replace
		* to change 'neutech-columbus' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'neutech-columbus', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'neutech_columbus_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'neutech_columbus_setup' );
 ...
 */
function neutech_columbus_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'neutech_columbus_content_width', 640 );
}
add_action( 'after_setup_theme', 'neutech_columbus_content_width', 0 );
 ...
 */
function neutech_columbus_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'neutech-columbus' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'neutech-columbus' ),
...
add_action( 'widgets_init', 'neutech_columbus_widgets_init' );
